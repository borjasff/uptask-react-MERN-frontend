...
const NewCollaborator = () => {
    ...
    const { getProyect, load, proyect, collaborator, addCollaborator, alert } = useProyects()
  ...
  return (
    <>
        <h1 className="text-4xl font-black" >Add Collaborator of {proyect.name} Proyect</h1>
    ...
    :
      collaborator.data?._id  && ( 
        <div className="flex justify-center mt-10">
            <div className="bg-white py-10 px-5 md:1/2 rounded-lg shadow">

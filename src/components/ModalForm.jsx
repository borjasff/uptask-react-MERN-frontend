...
const ModalFormTarea = () => {
    ...
    useEffect(() => {
        if(task._id){
            ...
            setEntryDate(task.entryDate?.split('T')[0])
            return
        }
        setId("")
        setName("")
    ...
    const handleSubmit = async e => {
        e.preventDefault();
        if([name, description, entryDate, priority].includes("")){
            showAlert({
                                    ...
                                    {msg && <Alert alert={alert}/>}
                                        <form 
                                            ...
                                            <div className='mb-5'>
                                                ...
                                                <input type="text" id="name" placeholder='Task Name' className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                            ...
                                            <div className='mb-5'>
                                                ...
                                                <textarea id="description" placeholder='Task description' className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                                        value={description} onChange={e => setDescription(e.target.value)}/>
                                            </div>
                                            <div className='mb-5'>
                                                <label htmlFor='entryDate' className='text-gray-700 uppercase font-bold text-sm'>
                                                    DeadLine Task
                                                </label>
                                                <input type="date" id="entryDate" className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                            ...
                                            <div className='mb-5'>
                                                ...
                                                <select id="priority" className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                            ...
                                            <input type="submit" value={id ? "Save Task" : "Add Task"}

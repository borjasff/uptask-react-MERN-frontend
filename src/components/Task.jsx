  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        <div className="flex flex-col items-start">
            ...
            {state && <p className="mb-2 text-xs uppercase p-1 rounded-lg text-white bg-green-600">Completed by: {task.completed.name}</p>}
        </div>  
        <div className="flex flex-col lg:flex-row gap-2">
            ...
            <button className={`${state ? 'bg-sky-600' : 'bg-gray-600'} px-4 py-3 uppercase font-bold text-sm rounded-lg text-white`}
